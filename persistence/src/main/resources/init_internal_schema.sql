...
--
-- Truncate table before insert `SCHEMAS_SCHEMA_ATTRIBUTE_PATHS_INSTANCES`
--

TRUNCATE TABLE `SCHEMAS_SCHEMA_ATTRIBUTE_PATHS_INSTANCES`;
--
-- Dumping data for table `SCHEMAS_SCHEMA_ATTRIBUTE_PATHS_INSTANCES`
--

INSERT INTO `SCHEMAS_SCHEMA_ATTRIBUTE_PATHS_INSTANCES` (`SCHEMA_ID`, `SCHEMA_ATTRIBUTE_PATH_INSTANCE_ID`) VALUES
(1, 1),
(2, 1),
(1, 2),
(1, 3),
